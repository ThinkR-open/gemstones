...
fusen::fill_description(
  pkg = here::here(),
  fields = list(
    Title = "Make Your 'golem' app shine",
    Description = "Make Your 'golem' app shine.",
    `Authors@R` = c(
      person("Colin", "Fay", email = "colin@thinkr.fr", role = c("aut", "cre"), comment = c(ORCID = "0000-0002-1565-9313")),
